...
> [!NOTE]
> Для быстрой проверки парсинга есть демо-страница:
> [renqismike.github.io/obhodiq](https://renqismike.github.io/obhodiq/)
>
> Введённые на этой странице ссылки **не сохраняются в базе**.
> Но важно учитывать, что сам факт обращения к подписке ваш VPN-провайдер **может посчитать как новое устройство или новую сессию**.
